...
export class Game2 extends BaseCena {
  constructor(controladorDeCenas) {
    ...
    this.endBgKey = "jogosDialogosFase2Fim";
  ...
  create() {
    ...
    this.dialogoFase2 = this.add.image(0, 0, "jogosDialogoFase2").setOrigin(0, 0);
    ...
    this.stepperFeedback = new StepperFeedback(this, {
      ...
      showPrimaryBeforeSecondary: true
    });
  ...
  renderMerchantCards() {
    ...
    const merchantCards = [TradeStateManager.CARD_IDS.SAL, TradeStateManager.CARD_IDS.TECIDO];
    const gap = 40;
    let cursorX = 0;
    let maxHeight = 0;
  ...
  handleConfirmTradeClick() {
    ...
    const invalidByMerchantTecido = merchantCardId === TradeStateManager.CARD_IDS.TECIDO;

    if (invalidByPlayerSalt || invalidByMerchantTecido) {
